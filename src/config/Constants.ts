...
export const BG_LAYERS: readonly BgLayer[] = [
  ...
  { key: 'bg_spaceship',        parallax: 0.28, tile: 4800, tint: 'struct', additive: true },
...
/**
 * Obstacle atlas — new long-panel approach (pack-obstacles-v2.py).
 * Each type has one WALL sprite (full long panel, ~664 px wide) and one PILLAR
 * sprite (for fork obstacles with 2 gaps). At runtime the engine crops the wall
 * panel to the needed width without ever tiling / repeating the texture.
 * Generated by scripts/pack-obstacles-v2.py — do not hand-edit.
 */
export interface ObstacleWallFrameDef {
  name: string;
  wallX: number; wallY: number; wallW: number; wallH: number;
  pillarX: number; pillarY: number; pillarW: number; pillarH: number;
}

export const OBSTACLE_WALL_FRAMES: ObstacleWallFrameDef[] = [
  { name: 'blue_bar',      wallX: 4, wallY: 4,   wallW: 664, wallH: 121, pillarX: 672, pillarY: 4,   pillarW: 107, pillarH: 121 },
  { name: 'green_bar',     wallX: 4, wallY: 129,  wallW: 664, wallH: 116, pillarX: 672, pillarY: 129, pillarW: 107, pillarH: 116 },
  { name: 'purple_pillar', wallX: 4, wallY: 249,  wallW: 664, wallH: 117, pillarX: 672, pillarY: 249, pillarW: 107, pillarH: 117 },
  { name: 'red_arrow',     wallX: 4, wallY: 370,  wallW: 664, wallH: 115, pillarX: 672, pillarY: 370, pillarW: 107, pillarH: 115 },
  { name: 'red_spike',     wallX: 4, wallY: 489,  wallW: 664, wallH: 116, pillarX: 672, pillarY: 489, pillarW: 107, pillarH: 116 },
  { name: 'stone_crack',   wallX: 4, wallY: 609,  wallW: 664, wallH: 82,  pillarX: 672, pillarY: 609, pillarW: 107, pillarH: 82  },
  { name: 'blue_tile',     wallX: 4, wallY: 695,  wallW: 664, wallH: 119, pillarX: 672, pillarY: 695, pillarW: 107, pillarH: 119 },
  { name: 'gold_block',    wallX: 4, wallY: 818,  wallW: 664, wallH: 119, pillarX: 672, pillarY: 818, pillarW: 107, pillarH: 119 },
];
